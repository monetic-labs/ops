...
// renamed from companyRegisteredAddressSchema to accountAddressSchema
...
//     taxId: z.string(),
//     expectedSpend: z.number().optional(),
//   }),
//   representatives: z.array(z.object({
...
export type UserDetailsSchema = z.infer<typeof companyUserDetailsSchema>;
export type CompanyRegisteredAddressSchema = z.infer<typeof accountAddressSchema>;
export type CompanyRepresentativeSchema = z.infer<typeof companyAccountUsersSchema>;
