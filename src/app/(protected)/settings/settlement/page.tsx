...
export default function CardSettlementSettingsPage() {
  ...
  const pageTitle = "Settlement Account Settings";
  const pageDescription =
    "Configure the destination account for funds received from various payment processing methods such as cards, wallets, and more via the Monetic widget or payment links. This ensures funds are routed correctly to your preferred operational account.";
