    ...
    parameters: {
      ...
      cost_tolerance: {
        ...
        max_premium_percentage: 
          basePreferences.parameters.cost_tolerance.max_premium_percentage * 
          energyType.feature_weights.risk_tolerance
      },
      speed_expectations: {
