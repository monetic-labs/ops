...
export const CompanyOwner: React.FC<CompanyOwnerProps> = ({
  ...
  const { control, handleSubmit, formState: { errors, isValid }, watch } = methods;
  ...
  const isStep2Complete = representatives.every((rep) => 
    rep.name && rep.surname && rep.email && rep.phoneNumber
  );
      ...
      <Tabs 
          ...
          >
            {fields.map((field, index) => {
              ...
              const tabTitle = ownerName && ownerSurname 
            ...
            <Tab key={index.toString()} title={tabTitle}>
              <div className="space-y-4 mt-4">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Tooltip className="tooltip-left-align" content="Owner can be a business owner or a representative of the business">
                      <Input
                        {...field}
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Tooltip
                      ...
                      content="Email address for the above listed owner"
                    >
                      <Input
                        {...field}
