      ...
      return options.filter((option) => {
        ...
        return (
          ...
          (relatedInfo?.capabilities &&
            relatedInfo.capabilities.some((cap) => cap.description.toLowerCase().includes(searchLower)))
        );
      });
              ...
              >
                ...
                {relatedInfo?.capabilities && relatedInfo.capabilities.length > 0 && (
                  <div className="text-xs text-gray-400 mt-1">
                    ...
                    {relatedInfo.capabilities.map((cap) => cap.description.split(".")[0]).join(", ")}
                  </div>
                )}
