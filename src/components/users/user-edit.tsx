  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <ModalContent>
        ...
        <ModalFooter>
          <Button onPress={() => setIsRemoveConfirmOpen(true)} className="bg-ualert-500 text-notpurple-500">
            Remove User
          </Button>
      ...
      >
        <ModalContent>
          ...
          <ModalBody>
            Are you sure you want to remove {user.name}? This action cannot be
            undone.
          </ModalBody>
          <ModalFooter>
            ...
            <Button onPress={handleRemove} className="bg-ualert-600 text-notpurple-500">
              Remove
            </Button>
          </ModalFooter>
        </ModalContent>
