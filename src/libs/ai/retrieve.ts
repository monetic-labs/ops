...
export const knowledgeBase: Record<string, string[]> = {
  ...
  'alerts': [
    "Alerts include features for transaction monitoring, dispute resolution, and transaction history."
  ],
  'compliance': [
    "Compliance includes features for transaction monitoring, dispute resolution, and transaction history."
  ]
};
...
export async function retrieveContext(query: string) {
  ...
  const defaultContext = "I am a helpful assistant focused on financial technology support. " +
