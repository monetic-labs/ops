export const ROLES_V3_ABI = [
  ...
  {
    inputs: [
      { internalType: "enum PermissionChecker.Status", name: "status", type: "uint8" },
  ...
  { inputs: [], name: "SetupModulesAlreadyCalled", type: "error" },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "bytes32", name: "roleKey", type: "bytes32" },
      ...
      { indexed: false, internalType: "enum ExecutionOptions", name: "options", type: "uint8" },
    ],
    name: "AllowFunction",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bytes32[]", name: "roleKeys", type: "bytes32[]" },
      { indexed: false, internalType: "bool[]", name: "memberOf", type: "bool[]" },
    ],
    name: "AssignRoles",
    type: "event",
  },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "bytes32", name: "allowanceKey", type: "bytes32" },
      { indexed: false, internalType: "uint128", name: "consumed", type: "uint128" },
      { indexed: false, internalType: "uint128", name: "newBalance", type: "uint128" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint128", name: "maxRefill", type: "uint128" },
      { indexed: false, internalType: "uint128", name: "refill", type: "uint128" },
      { indexed: false, internalType: "uint64", name: "period", type: "uint64" },
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: "address", name: "module", type: "address" },
      { indexed: false, internalType: "bytes32", name: "defaultRoleKey", type: "bytes32" },
    ],
    name: "SetDefaultRole",
    type: "event",
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bytes4", name: "selector", type: "bytes4" },
      { indexed: false, internalType: "contract ITransactionUnwrapper", name: "adapter", type: "address" },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "to", type: "address" },
      { internalType: "bytes4", name: "selector", type: "bytes4" },
      { internalType: "contract ITransactionUnwrapper", name: "adapter", type: "address" },
    ],
  ...
  },
  {
    inputs: [{ internalType: "bytes32", name: "", type: "bytes32" }],
    name: "unwrappers",
    outputs: [{ internalType: "contract ITransactionUnwrapper", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
] as const;
