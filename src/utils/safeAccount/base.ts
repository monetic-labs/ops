...
//   /**
//    * Formats and sends a user operation
//    * @param userOperation - User operation to format and send
//    * @param signerSignaturePair - Signature pair for the operation
//    * @returns Receipt of the operation
//    */
//   async formatAndSendUserOp(userOperation: UserOperationV7, signerSignaturePair: SignerSignaturePair) {
...
//   public buildDeployTx(safeAddress: Address): MetaTransaction {
//     const settlementFactoryData = SafeAccount.createFactoryAddressAndData([safeAddress], { threshold: 1 });
//     const factoryAddress = settlementFactoryData[0];
//     const factoryData = settlementFactoryData[1];

//     // Create deployment transaction for settlement account
//     const deploySettlementTx: MetaTransaction = {
//       to: factoryAddress,
//       data: factoryData,
//       value: BigInt(0),
//     };

//     return deploySettlementTx;
//   }
